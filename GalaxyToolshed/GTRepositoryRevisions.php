...
class GTRepositoryRevisions extends GalaxyToolshed {
   ...
   * @param string $changeset_revision the changeset_revision of the RepositoryMetadata object associated with the Repository
   * @param bool $export_repository_dependencies (optional): whether to export repository dependencies - defaults to False
   * @param string $download_dir (optional): the local directory to which to download the archive - defaults to /tmp
   */
